...
alias t="tmux new -c /home/satrujit -s default-session && tmux attach-session -t default-session || tmux attach"
...
if command -v tmux &> /dev/null && [ -z "$TMUX" ]; then
  tmux new -c /home/satrujit -s default-session && tmux attach-session -t default-session || tmux attach
fi
